    ...
    <div class="product">
      ...
      <div class="product-box">
          ...
          <client-only>
            ...
            <template v-else>
              <div class="catalog-cart">
                <div
                  class="plus"
                  @click.prevent="addToCart(product)"></div>
                {{ countInCart }} шт.
                <div
                  class="minus"
                  @click.prevent="decreaseQtyById"></div>
              </div>
        ...
        <div class="product-content">
          ...
          <div class="product-weight">{{ product.weight * 1000 }} гр</div>
          ...
          <div class="product-desc">
            <template v-if="product.composition && product.composition.trim().length">
              <div class="product-desc-title">Состав</div>
  ...
  methods: {
    ...
    async like() {
      try {
        ...
        this.$store.commit('catalog/setLikes', { id: this.product.id, likes: likes });
