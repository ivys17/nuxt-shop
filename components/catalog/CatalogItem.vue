<template>
  <div class="catalog-item">
    ...
    >
      ...
      >
        <div
          v-for="sticker in item.tags"
          :class="`catalog-item__sticker--${sticker}`"
          class="catalog-item__sticker"
        />
      </div>
    ...
    <div class="catalog-item-info">
      <div class="catalog-item-text">
        <nuxt-link
          :to="`/menu/${currentSectionDataAlias}/${item.slug}`"
      ...
      <div class="catalog-item-bottom">
        ...
        <client-only>
          ...
          >
            <div
              class="qnt-btn qnt-minus"
              @click="decreaseQtyById"
            />
            <input
              :value="countInCart"
              readonly
