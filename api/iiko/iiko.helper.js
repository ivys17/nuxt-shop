export const getModifiersFromIikoData = (products) => products.reduce((acc, p) => {
  if (!p.modifiers) {
    return acc;
  }
...
export const isCompanyEmployee = (userCategories) => userCategories.map((uc) => uc.id).includes('4be14fbd-bb2c-42c5-92d0-325e3ae4d4df');
