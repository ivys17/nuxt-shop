      ...
      <div class="info-box">
        <div class="info-banner">
          ...
          <div
            ...
            class="banner-box"
          >
            <label v-for="slide in slides.desktop">
              <span class="banner">
                <img
                  :src="`/${slide.path}`"
                  alt="banner"
        ...
        <div class="info-banner">
          ...
          <div
            ...
            class="banner-box"
          >
            <label v-for="slide in slides.mobile">
              <span class="banner">
                <img
                  :src="`/${slide.path}`"
                  alt="banner"
...
export default {
  ...
  methods: {
    async addSlide(evt, isMobile) {
      ...
      try {
        const { data: newFileData } = await this.$axios.post(
          '/api/file/upload',
          formData,
          {
            headers: {
        ...
        const { data: newSlideData } = await this.$axios.post(
          '/api/slide/',
          newSlide,
          {
            headers: {
